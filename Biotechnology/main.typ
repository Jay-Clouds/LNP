...
#figure(
  image("TUM-Logo.svg", width: 80%),
  placement: top,
  caption: [
    Logo of Technical University Munich.
  ],
)
...
== Familial Natural Short Sleep and DEC2 Mutations
...
- Ethical framework for genetic enhancement